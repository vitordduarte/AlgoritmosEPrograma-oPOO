...
int main()
{
    ...
    Mago mago2("Harry Potter",12,"Hogwarts", "harry", 100);
    Mago mago3("Gandalf",300,"Mordor", "senhor", 300);
    Mago mago4 ("Vitor", 10, "unisinos", "aulapoo", 100);

    std::cout <<"magos instanciados" << std::endl;
