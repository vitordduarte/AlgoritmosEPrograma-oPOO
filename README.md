...
| `Trabalho Grau B`      | C++   | Desenvolvimento de uma loja online, com persistência de dados e produtos onde um usuário pode solicitar. Projeto do Grau B da disciplina. Link para o trabalho ... |
